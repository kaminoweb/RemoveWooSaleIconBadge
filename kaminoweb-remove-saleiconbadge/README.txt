...
Donate link: https://kaminoweb.com/
Tags: remove,sale icon,badge,woocommerce
...
You can also:
1. Manually delete the `kaminoweb-remove-saleiconbadge` directory into the `/wp-content/plugins/` directory
